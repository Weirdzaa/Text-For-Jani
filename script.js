$(document).ready(function () {
     ...
     */
    var content = [{
        title: "Haii Widol Cantik <3",
        desc: ""
    }, {
        title: "Aku Sayang Kamu!",
        desc: "bener ko aku sayang kamu, dan udah pasti selalu gaakan berhenti. Kamu juga sayang aku kan? Semoga kita berlanjut terus yaa tanpa ada kata pisah:("
    }, {
       title: "Aku Minta Maaf:(",
       desc: "maaf sayang:( aku selalu bikin kamu bt terus, aku mengakui kesalahan aku ko, marahin aku yaa kalo semisal aku salah jangan diem okey:("
    }, {
        title: "Terima Kasih!",
        desc: "makasii banyak sayang udahh nerima aku sepenuh hati kamu, aku beruntungg bangett punya kamu yg cantik,rajin,solehah dan baik hati ini <3"
    }, {
        title: "I LOVE U MI AMOR",
        desc: "From Izaa"
 }];
    var currentPage = 0;
    //generate content
